...
class Net(nn.Module):
    def __init__(self, num_labels):
        ...
        self.conv1 = nn.Conv2d(   1, ks*1, fs, padding=ps)
        self.bn1 = nn.BatchNorm2d(ks*1)       
        self.conv2 = nn.Conv2d(ks*1, ks*2, fs, padding=ps)
        self.bn2 = nn.BatchNorm2d(ks*2)       
        self.conv3 = nn.Conv2d(ks*2, ks*3, fs, padding=ps)
        self.bn3 = nn.BatchNorm2d(ks*3)       
        
        '''
        self.dconv1 = nn.Conv2d(ks*3, ks*2, fs, padding=ps)
        self.db1 = nn.BatchNorm2d(ks*3)       
        self.dconv2 = nn.Conv2d(ks*2, ks*1, fs, padding=ps)
        self.db2 = nn.BatchNorm2d(ks*1)       
        '''
        self.det1 = nn.Conv2d(ks*1, self.numl, fs, padding=ps)
        self.det2 = nn.Conv2d(ks*2, self.numl, fs, padding=ps)
        self.det3 = nn.Conv2d(ks*3, self.numl, fs, padding=ps)
        #self.det4 = nn.Conv2d(ks*2, self.numl, fs, padding=ps)
        #self.det5 = nn.Conv2d(ks*1, self.numl, fs, padding=ps)
    ...
    def forward(self, x, Xavg, Xstd):
        ...
        '''
        d1 = self.det1(self.dp(c1))
        d2 = self.det2(self.dp(c2))
        d3 = self.det3(self.dp(c3))
        #d4 = self.det4(c4)
        #d5 = self.det5(c5)
