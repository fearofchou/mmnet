...
class block(nn.Module):
    def __init__(self, inp, out):
        ...
        self.conv1 = nn.Conv2d(inp, out, (3,3), padding=(1,1), bias=False)
        self.bn2 = nn.BatchNorm2d(out)       
        self.conv2 = nn.Conv2d(out, out, (3,3), padding=(1,1), bias=False)
...
class Net(nn.Module):
    def __init__(self, channel, num_classes):
        ...
        inp = 64/2
        self.conv1 = nn.Conv2d(1, 3, self.ks, padding=self.ps)
        self.b1 = block(   3, 16)
        self.b2 = block(16, inp*2)
        self.b3 = block(inp*2, inp*3)
